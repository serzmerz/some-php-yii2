...
/* @var $searchModel common\models\Search\InvestorsSearch */
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
              ...
              <p class="lead text-center">Manage and follow your investors.</p>
            </div>
          </div>
        </div>
      </section>
<section>
    <div class="container">
        <h3 class="heading">We have found <span class="accent"><?=$count?></span> investors</h3>
        <div class="row">
            <div class="col-lg-12 text-right margin-bottom--big">
        <?=Html::a('<i class="fa fa-plus"></i>Add new investor',
            ['create'],
